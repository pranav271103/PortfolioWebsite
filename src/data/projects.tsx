...
const projects: Project[] = [
  ...
  { // 01. Multimodal AI System
    id: "multimodalai",
    category: "AI/ML & Multimodal Systems",
    title: "Multimodal AI System",
    src: "/assets/projects-screenshots/multimodalrag/1.png",
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            MultiModal AI Pipeline is an advanced system designed to process and analyze multiple data 
            modalities including text, audio, images, and video. Built with scalability and performance 
            in mind, it provides a unified interface for various AI tasks across different data types.
          </TypographyP>
          <SlideShow
            images={[
              `${BASE_PATH}/multimodalrag/1.png`,
              `${BASE_PATH}/multimodalrag/2.png`,
              `${BASE_PATH}/multimodalrag/3.png`
            ]}
          />
        </div>
      );
  ...
  { // 02. Reputation Monitor
    id: "reputationmonitor",
    category: "Agentic AI & NLP",
    title: "Advanced Reputation Monitor",
    src: "/assets/projects-screenshots/reputationmonitor/1.png",
    screenshots: ["1.png", "2.png", "3.png"],
    skills: {
      frontend: [],
      backend: []
    },
    live: "https://pranav271103.github.io/Reputation-Monitor/",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/reputationmonitor/1.png`,
              `${BASE_PATH}/reputationmonitor/2.png`,
              `${BASE_PATH}/reputationmonitor/3.png`
            ]}
          />
        </div>
      );
  ...
  { // 03. Jarvis AI Assistant
    id: "jarvisai",
    category: "AI, NLP, Speech & Automation",
    title: "Jarvis AI Assistant",
    src: "/assets/projects-screenshots/jarvisai/1.png",
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/jarvisai/1.png`,
              `${BASE_PATH}/jarvisai/2.png`,
              `${BASE_PATH}/jarvisai/3.png`,
              `${BASE_PATH}/jarvisai/4.png`,
              `${BASE_PATH}/jarvisai/5.png`,
              `${BASE_PATH}/jarvisai/6.png`
            ]}
          />
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc pl-6 font-mono space-y-2">
            <li>Voice and Text Interface for natural interaction</li>
  ...
  { // 04. AI Therapist
    id: "aitherapist",
    category: "Agentic AI, NLP & Mental Health",
    title: "AI Therapist",
    src: "/assets/projects-screenshots/aitherapist/1.png",
    screenshots: ["1.png", "2.png", "3.png", "4.png"],
    skills: {
      frontend: [],
      backend: []
    },
    live: "https://ai-therapist-black.vercel.app/",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            A modern, AI-powered therapeutic chat application that provides mental health support 
            through natural conversations. Built with Next.js and powered by Gemini AI, this 
            application offers a safe space for users to express their thoughts and receive 
            supportive responses. The intuitive interface ensures a seamless experience while 
            maintaining privacy and security for all user interactions.
          </TypographyP>
          <ProjectsLinks live={this.live} />
          <SlideShow
            images={[
              `${BASE_PATH}/aitherapist/1.png`,
              `${BASE_PATH}/aitherapist/2.png`,
              `${BASE_PATH}/aitherapist/3.png`,
              `${BASE_PATH}/aitherapist/4.png`
            ]}
          />
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc pl-6 font-mono space-y-2">
            <li>AI-powered therapeutic conversations</li>
            <li>Secure and private chat interface</li>
            <li>Responsive design for all devices</li>
            <li>Built with Next.js and Gemini AI integration</li>
  ...
  { // 05. Code Explainer
    ...
    src: "/assets/projects-screenshots/codeexplainer/1.png",
    screenshots: ["1.png", "2.png", "3.png", "4.png"],
    skills: {
      frontend: [],
      backend: []
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/codeexplainer/1.png`,
              `${BASE_PATH}/codeexplainer/2.png`,
              `${BASE_PATH}/codeexplainer/3.png`,
              `${BASE_PATH}/codeexplainer/4.png`
            ]}
          />
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc pl-6 font-mono space-y-2">
  ...
  { // 06. HelperAgent
    id: "helperagent",
    category: "Agentic AI, Computer Vision & Education",
    title: "HelperAgent - AI Homework Assistant",
    src: "/assets/projects-screenshots/helperagent/1.png",
    screenshots: ["1.png", "2.png", "3.png"],
    skills: {
      frontend: [],
      backend: []
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/helperagent/1.png`,
              `${BASE_PATH}/helperagent/2.png`,
              `${BASE_PATH}/helperagent/3.png`
            ]}
          />
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc pl-6 font-mono space-y-2">
